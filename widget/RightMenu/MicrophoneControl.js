...
export default function MicrophoneControl() {
    ...
    return (_jsxs("box", { cssClasses: ["quick-settings-item", "mic-control-item"], spacing: 12, children: [muteButton, slider, _jsx("button", { cssClasses: ["arrow-button"], onClicked: () => execAsync("pavucontrol").catch(() => { }), children: _jsx("label", { label: "\uF105", cssClasses: ["toggle-arrow"] }) })] }));
}
